        ...
        <a href="halaman_pertama.html" style="text-decoration: none; color: inherit;">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-9">
                    ...
                    <p>Diberitahukan kepada mahasiswa program studi Teknik Informatika S1 yang belum diplot/mendapatkan
                        Dosen Pembimbing TA di siadin. Harap dapat mengajukan permohonannya melalui aplikasi web SPDP TA
                        yang dapat...
                    </p>
                    <hr>
                    <p>By : Koordinator TA TI S-1</p>
