<nav class="navbar navbar-expand-lg menu navbar-dark fixed-top" id="navbar">
    <div class="container">
        <a class="navbar-brand" href="<?php echo base_url('dashboard') ?>">
            <img src="<?php echo base_url() ?>assets/front-end/assets/images/lgo.png" alt="logo" width="200" height="50"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                ...
                <li class="nav-item dropdown mx-1">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="informasiDropdown">
                        ...
                        <li><a class="dropdown-item text-black text-center"
                                href="<?php echo base_url('dashboard/info_ta1') ?>">Tugas Akhir 1</a></li>
                        <!-- Opsi 2 -->
                        <li><a class="dropdown-item text-black text-center"
                                href="<?php echo base_url('dashboard/info_ta2') ?>">Tugas Akhir 2</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item mx-1"><a class="nav-link"
                        href="<?php echo base_url('dashboard/pengumuman') ?>">Pengumuman</a>
                </li>
                <li class="nav-item mx-1"><a class="nav-link"
                        href="<?php echo base_url('dashboard/jadwal') ?>">Jadwal</a></li>
                <li class="nav-item mx-1"><a class="nav-link"
                        href="<?php echo base_url('dashboard/kontak') ?>">Kontak</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-12 col-sm-12 ">
                <div class="container mt-lg-5">
                    <div class="header-hero-content text-center pt-sm-5" style="margin-top: 80px;" data-aos="fade-right"
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 mt-md-5 mb-md-5" data-aos="fade-left" data-aos-duration="1500">
                <img src="<?php echo base_url() ?>assets/front-end/assets/images/banner1.svg" alt=""
                    class="mt-lg-5 ms-lg-5">
            </div>
        </div>
    </div>
    <svg class="frame" width="100%" height="100%" viewBox="0 0 1400 320" fill="#fffff"
        xmlns="http://www.w3.org/2000/svg">
        <path
            d="M0.0244141 213.32L64.0228 234.652C128.021 255.984 256.018 298.648 384.015 277.316C512.012 255.984 640.008 170.656 768.005 177.722C896.002 185.321 1024 283.982 1152 270.249C1279.99 255.984 1407.99 127.992 1535.99 99.5934C1663.98 70.6619 1791.98 142.657 1855.98 177.722L1919.98 213.32V426.64H1855.98C1791.98 426.64 1663.98 426.64 1535.99 426.64C1407.99 426.64 1279.99 426.64 1152 426.64C1024 426.64 896.002 426.64 768.005 426.64C640.008 426.64 512.012 426.64 384.015 426.64C256.018 426.64 128.021 426.64 64.0228 426.64H0.0244141V213.32Z"
            fill="white" />
    </svg>
</div>
<!-- About Section-->
...
<section class="bg-white py-5 my-5 mt-md-5">
    ...
    <div class="container"
        style="background-image: url('<?php echo base_url() ?>assets/front-end/assets/images/section1.svg'); height: 400px;">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end" data-aos="fade-left"
                data-aos-duration="1000">
                <div>
                    <img src="<?php echo base_url() ?>assets/front-end/assets/images/dinus600.jpg" alt="..."
                        class="h-75 w-75">
                </div>
            </div>
        </div>
    ...
    <div class="container"
        style="background-image: url('<?php echo base_url() ?>assets/front-end/assets/images/section2.svg'); height: 400px;">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start" data-aos="fade-right"
                data-aos-duration="1000">
                <div>
                    <img src="<?php echo base_url() ?>assets/front-end/assets/images/img-2-600.png" alt="..."
                        class="h-75 w-75">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
    ...
    <div class="container"
        style="background-image: url('<?php echo base_url() ?>assets/front-end/assets/images/section3.svg'); height: 400px;">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
                <div class="services__content" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end" data-aos="fade-left"
                data-aos-duration="1000">
                <div>
                    <img src="<?php echo base_url() ?>assets/front-end/assets/images/p2.svg" alt="..."
                        class="h-75 w-75">
                </div>
            </div>
        </div>
...
<section class="py-5">
    <div class="container px-5 rounded-4"
        ...
        <div class="container ">
            <div class="row mb-2">
                ...
                <div class="col-6 text-end " data-aos="fade-left" data-aos-duration="2000">
                    <a href="<?php echo base_url('dashboard/dosbim') ?>"
                        class="text-gradient text-decoration-none text-judul">Selengkapnya</a>
                </div>
            </div>
        </div>
        <div class="row gx-5">
                            ...
                            <?php foreach ($dosbim as $dsn): ?>
                                <div class="col-lg-2 col-md-6 col-sm-4 mb-3 " data-aos="fade-up" data-aos-duration="2000">
                                    ...
                                    <div class="card rounded-5 border-0 ">
                                        <img src="<?php echo base_url('uploads/' . $dsn->gambar); ?>"
                                            class="card-img-top card2" alt="Profile Picture 1" style="border-radius: 35px;">
                                        <div class="card-body ">
                ...
                <div class="card rounded-5" style="border-color:#FF5F6D;">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <button class="btn-1 border-0 bg-white rounded-3">
                                    <a href="jadwal.html" class="btn text-start">
                                        <h5>Pendaftaran Sidang TA Gel IV</h5>
