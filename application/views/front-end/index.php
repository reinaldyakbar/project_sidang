    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                <li class="nav-item mx-1"><a class="nav-link active" href="<?php echo base_url('dashboard') ?>">Home</a>
                </li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-12 col-sm-12 ">
                    <div class="container mt-lg-5">
                        <div class="header-hero-content text-center pt-sm-5" style="margin-top: 80px;"
            ...
            <div class="container ">
                <div class="row mb-2 ">
                    ...
                    <div class="col-6 text-end " data-aos="fade-left" data-aos-duration="2000">
                        <a href="dosbim.html" class="text-gradient text-decoration-none text-judul">Selengkapnya</a>
                    </div>
                </div>
            </div>
            <div class="row gx-5">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                    ...
                                    <ul class="list-unstyled txt-footer">
                                        <li><a href="mailto:defri.kurniawan@dsn.ac.id"
                                                class="text-white text-decoration-none"><i
                                                    class="bi bi-envelope"></i>&nbsp defri.kurniawan@dsn.ac.id</a>
                                        </li>
                                ...
                                <div class="col-md-5 col-foot">
                                    <ul class="list-unstyled txt-footer">
                                        <li><a href="mailto:danang.wu@dsn.ac.id"
                                                class="text-white text-decoration-none"><i
