<body>
    <header>
        <div class="navbar-area">
            <div class="container"
                style="background: linear-gradient(to right, #1488cc, #2b32b2); border-radius: 0 0 25px 25px;">
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg" id="navbar">
                            <a class="navbar-brand" href="<?php echo base_url('dashboard') ?>">
                                <img src="<?php echo base_url() ?>assets/front-end/assets/images/lgo.png" alt="logo"
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
                                    ...
                                    <li class="nav-item dropdown mx-1">
                                        <a class="nav-link dropdown-toggle" href="#" id="informasiDropdown"
